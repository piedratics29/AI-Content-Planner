...
@Component({
  ...
  template: `
    <div id="register-container" class="min-h-screen flex items-center justify-center bg-slate-50 px-3 sm:px-4 py-6 sm:py-12">
      <div id="register-card" class="w-full max-w-md bg-white rounded-2xl border border-slate-200/80 shadow-sm p-5 sm:p-8">
